...
M.set = function()
    ...
    hl('@punctuation.parameter.property', { fg = colors.purple_1 })
    hl('@constant', { fg = colors.violet_4 })
    ...
    hl('LspReferenceTarget', { bg = colors.blue_1 })
    ...
    hl('@type.fsharp', { fg = colors.yellow_6 })
    hl('@type.definition.fsharp', { fg = colors.orange_5 })
    hl('@lsp.type.cexpr.fsharp', { fg = colors.yellow_6 })
